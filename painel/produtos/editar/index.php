...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_produto( $id,$eid,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$video_link,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) ) {
