...
function gera_comprovante_pdv(
    ...
    foreach ($itens as $key => $value) {
        ...
        $comprovante .= "#" . $data_content['ref'] . " \n<br>";
        $comprovante .= "<div class='prod-comprovante'><img src='https://" . $subdominio . "." . $simple_url . "/_core/_upload/" . $data_content['destaque'] . "'>";
        $comprovante .= "<div class='txt-valor-prod'><strong>" . $value['quantidade'] . " x</strong> " . $data_content['nome'] . "\n<br>";
        if ($value['variacoes'] != "") {
    ...
    $total = "R$ " . (dinheiro($subtotal_valor  - $cupom_descontado, "BR"));
