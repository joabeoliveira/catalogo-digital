		...
		<div class="container">
			...
			<div class="row" data-aos="fade-up">
				...
				<div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
					<a href="https://demo3.<?php echo $simple_url; ?>" target="_blank">
						<div class="count-box">
							<img src="https://demo3.<?php echo $simple_url; ?>/_core/_uploads/14/2021/11/14432711213c83gb23ge_thumb.jpg" width="150" class="img-fluid">
							<h4>Du Cheff</h4>
						</div>
					</a>
				</div>
					...
					<li data-aos="fade-up" data-aos-delay="400"> <i class="bx bx-help-circle icon-help"></i>  <a data-bs-toggle="collapse" data-bs-target="#faq-list-10" class="collapsed">Vocês possuem parcerias com agências ou afiliados? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
						<div id="faq-list-10" class="collapse" data-bs-parent=".faq-list">
							<p>Sim, você pode divulgar os serviços do <?php echo $nome_loja; ?> em sua cidade e ainda ganhar uma boa comissão por cada cliente inserido em nosso sistema.
								...
								<br/>
								<br/> <strong>(12) 98299-0829</strong>
							</p>
						</div>
					</li>
				</ul>
